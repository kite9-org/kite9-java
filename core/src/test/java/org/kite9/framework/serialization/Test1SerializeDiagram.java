...
public class Test1SerializeDiagram extends HelpMethods {
	...
	public static Diagram createDiagram(KeyHelper kh) {
	    Glyph g1 = new Glyph("class", "Test Class", createList(
	    		new TextLine("Here is a line of text", createList(kh.createSymbol("Baphomet", "B")))), 
	    		createList(kh.createSymbol("Public", "P")));
	    ...
	    Context inside = new Context(createList((Contained) g1, g2, g3), true, null, null);
	    
	    new Link(a1, g1, null, null, LinkEndStyle.ARROW, new TextLine("Some Label"), Direction.RIGHT);
	    new Link(a1, g2);
	    new Link(a1, g3);
	    
	    
	    Diagram d1 = new Diagram("My Diagram", createList((Contained) inside, (Contained) a1), 
	    		new Key("Here is my amazing diagram", null, kh.getUsedSymbols()));
	    return d1;
	}
}
