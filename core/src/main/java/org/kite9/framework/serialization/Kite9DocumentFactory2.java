 ...
 * @version $Id$
 */
public class Kite9DocumentFactory2
     ...
     */
    public Kite9DocumentFactory2(String parser) {
     ...
     */
    public Kite9DocumentFactory2(String parser, boolean dd) {
        ...
        try {
            synchronized (LOCK) {
                ...
                if (dtdProps == null) {
                    ...
                    try {
                        Class cls = Kite9DocumentFactory2.class;
