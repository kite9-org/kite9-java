 ...
 *
 */
public class SimpleNounImpl implements SimpleNoun {

	public SimpleNounImpl(Object represented, Aliaser a) {
		this(represented, a, null);
	}
	
    public SimpleNounImpl(Object represented, Aliaser a, List<NounPart> disambiguation) {
	super();
	...
	public boolean equals(Object obj) {
		...
		if (getClass() != obj.getClass())
			return false;
		SimpleNounImpl other = (SimpleNounImpl) obj;
