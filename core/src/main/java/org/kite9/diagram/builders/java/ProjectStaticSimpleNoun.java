 ...
 *
 */
public class ProjectStaticSimpleNoun implements SimpleNoun {

	public ProjectStaticSimpleNoun(Object represented, Aliaser a) {
		this(represented, a, null);
	}
	
    public ProjectStaticSimpleNoun(Object represented, Aliaser a, List<NounPart> disambiguation) {
	super();
