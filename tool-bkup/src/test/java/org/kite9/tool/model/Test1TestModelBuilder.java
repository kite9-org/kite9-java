...
import org.kite9.tool.integration.AbstractRunnerTest;
...
public class Test1TestModelBuilder {
	...
	private static Kite9Context createContext() {
		Aliaser a = new PropertyAliaser();
		Repository<File> r = new BasicFileRepository();
		Kite9ContextImpl out = new Kite9ContextImpl(a, r);
		out.setClassPath("target/classes" + File.pathSeparator
				+ "target/test-classes");
		out.setSecretKey("somerubbish");
