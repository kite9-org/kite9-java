...
public class Test1SpringScanner extends AbstractRunnerTest {

	static final String LINE1 = "Here is a kite9 item as a string";
	static final String LINE2 = "Some other item";
	static final String LINE3 = "project_java_class:"+Test1SpringScanner.class.getName();
	...
	public String item3(DiagramBuilder db) {
	    String name = db.getId(Test1SpringScanner.class);
	    return name;
	}
